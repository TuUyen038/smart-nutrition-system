...
const { searchByIngredientName, getAllRecipe, findRecipeByName, detectImage, findIngrAndInstrByAi, getBackUpNutrition, createNewRecipe, getRecipeById, findIngredientsByAi } = require('../controllers/recipe.controller');
